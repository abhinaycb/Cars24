...
class MainViewController: UIViewController,Navigationable,UITableViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    let headerForCollectionView:UILabel = {
        ...
        label.text = StringConstants.propertyHeaderText
    ...
    let facilityCollectionView:UICollectionView = {
        ...
        collectionView.register(FacilityCollectionViewCell.self, forCellWithReuseIdentifier: StringConstants.collectionViewCellIdentifier)
    ...
    let headerForTableView:UILabel = {
        let label = UILabel()
        label.text = StringConstants.facilityHeaderText
    ...
    func bindViewsWithDataModel() {
        ...
        let collectionViewDataSource = RxCollectionViewSectionedReloadDataSource<SectionModel<String, Option>>(
            configureCell: { (datasource, collectionView, indexPath, option) -> UICollectionViewCell in
                let cell = self.facilityCollectionView.dequeueReusableCell(withReuseIdentifier: StringConstants.collectionViewCellIdentifier, for: indexPath) as! FacilityCollectionViewCell
        ...
        //MARK: (TableViewCell/CollectionViewCell)Selection Listners
...
//MARK: Delegate Methods Collection/Table View
extension MainViewController {
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let width = self.view.bounds.width
        let cellWidth = (width) / 3 - 35.0  // compute your cell width
        return CGSize(width: cellWidth, height: IntConstants.collectionViewItemHeight)
    }
    
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return IntConstants.tableHeight
    }
